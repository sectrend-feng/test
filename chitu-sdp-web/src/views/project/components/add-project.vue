      ...
      <a-form-model :model="form">
        <div class="form-body">
              ...
              <div slot="dropdownRender"
                ...
                <div style="
                  ...
                  <a-button type="primary"
                            size="small"
                            @click.stop.prevent="selectEngineConfirm">确认</a-button>
                </div>
              </div>
              <a-select-option v-for="(item, index) in engineData"
          ...
          <a-form-model-item>
            ...
            <a-select v-model="form.productLineName"
